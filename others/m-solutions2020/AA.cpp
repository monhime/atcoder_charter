...
int main(){
    ...
    if (x >= 400 and x <= 599) io.writeln(8);
    else if (x >= 600 and x <= 799) io.writeln(7);
    else if (x >= 800 and x <= 999) io.writeln(6);
    else if (x >= 1000 and x <= 1199) io.writeln(5);
    else if (x >= 1200 and x <= 1399) io.writeln(4);
    else if (x >= 1400 and x <= 1599) io.writeln(3);
    else if (x >= 1600 and x <= 1799) io.writeln(2);
    else io.writeln(1);
