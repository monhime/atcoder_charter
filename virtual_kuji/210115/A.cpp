...
int main(){
    ...
    if (x >= 400 && x <= 599) io.writeln(8);
    else if  (x >= 600 && x <= 799) io.writeln(7); 
    else if  (x >= 800 && x <= 999) io.writeln(6);  
    else if  (x >= 1000 && x <= 1199) io.writeln(5); 
    else if  (x >= 1200 && x <= 1399) io.writeln(4); 
    else if  (x >= 1400 && x <= 1599) io.writeln(3);
    else if  (x >= 1600 && x <= 1799) io.writeln(2); 
    else if  (x >= 1800 && x <= 1999) io.writeln(1); 
